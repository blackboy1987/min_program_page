...
import com.bootx.util.wechat.response.datacube.*;
...
public final class DataCubeUtils {
    ...
    public static DataCubeUserSummaryResponse userSummary(Date beginDate, Date endDate){
        ...
        params.put("begin_date", DateUtils.formatDateToString(beginDate,"yyyy-MM-dd"));
        params.put("end_date", DateUtils.formatDateToString(endDate,"yyyy-MM-dd"));
    ...
    public static DataCubeArticleSummaryResponse getArticleSummary(Date date){
        ...
        Map<String,Object> params = new HashMap<>(16);
        params.put("begin_date", DateUtils.formatDateToString(date,"yyyy-MM-dd"));
        params.put("end_date", DateUtils.formatDateToString(date,"yyyy-MM-dd"));
     ...
     *
     */
    public static DataCubePublisherAdposGeneralResponse publisher_adpos_general(Integer page,Integer pageSize,Date beginDate, Date endDate,String accessToken){
        String url="https://api.weixin.qq.com/publisher/stat";
        Map<String,Object> params = new HashMap<>(16);
        params.put("start_date", DateUtils.formatDateToString(beginDate,"yyyy-MM-dd"));
        params.put("end_date", DateUtils.formatDateToString(endDate,"yyyy-MM-dd"));
